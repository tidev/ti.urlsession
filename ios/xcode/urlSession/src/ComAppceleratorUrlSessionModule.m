...
-(id)moduleGUID
{
	return @"cbf3cdea-b7e8-4375-bdfb-70fb9307054d";
}
...
-(void)startup
{
	...
	ComAppceleratorUrlSessionModule *me = self;

	// run the hyperloop module in the global context of kroll
	HyperloopJS* module = HyperloopRunInVM(ctx,@"./app",@"com_appcelerator_urlSession_",^(TiContextRef context, TiObjectRef exports){
