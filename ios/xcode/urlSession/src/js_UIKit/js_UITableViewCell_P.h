...
extern JSValueRef HyperloopUIImageViewToJSValueRef(JSContextRef,UIImageView *);
extern JSValueRef HyperloopUILabelToJSValueRef(JSContextRef,UILabel *);
extern JSValueRef HyperloopUITableViewCellAccessoryTypeToJSValueRef(JSContextRef,UITableViewCellAccessoryType);
extern JSValueRef HyperloopUITableViewCellEditingStyleToJSValueRef(JSContextRef,UITableViewCellEditingStyle);
extern JSValueRef HyperloopUITableViewCellSelectionStyleToJSValueRef(JSContextRef,UITableViewCellSelectionStyle);
...
extern UITableViewCellAccessoryType HyperloopJSValueRefToUITableViewCellAccessoryType(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern UITableViewCellSelectionStyle HyperloopJSValueRefToUITableViewCellSelectionStyle(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern UITableViewCellStateMask HyperloopJSValueRefToUITableViewCellStateMask(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern UITableViewCellStyle HyperloopJSValueRefToUITableViewCellStyle(JSContextRef,JSValueRef,JSValueRef*,bool*);
