...
extern JSValueRef HyperloopNSTextStorageEditActionsToJSValueRef(JSContextRef,NSTextStorageEditActions);
...
extern JSValueRef Hyperloopid_NSTextStorageDelegate_ToJSValueRef(JSContextRef,id<NSTextStorageDelegate>);
...
extern id<NSTextStorageDelegate> HyperloopJSValueRefToid_NSTextStorageDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
