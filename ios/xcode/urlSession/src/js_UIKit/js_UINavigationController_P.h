...
extern JSValueRef HyperloopUINavigationBarToJSValueRef(JSContextRef,UINavigationBar *);
extern JSValueRef HyperloopUINavigationControllerToJSValueRef(JSContextRef,UINavigationController *);
extern JSValueRef HyperloopUIToolbarToJSValueRef(JSContextRef,UIToolbar *);
...
extern JSValueRef Hyperloopid_UINavigationControllerDelegate_ToJSValueRef(JSContextRef,id<UINavigationControllerDelegate>);
...
extern id<UINavigationControllerDelegate> HyperloopJSValueRefToid_UINavigationControllerDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
