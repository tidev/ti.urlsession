...
extern JSValueRef HyperloopUIFontDescriptorSymbolicTraitsToJSValueRef(JSContextRef,UIFontDescriptorSymbolicTraits);
extern JSValueRef HyperloopUIFontDescriptorToJSValueRef(JSContextRef,UIFontDescriptor *);
...
extern UIFontDescriptorSymbolicTraits HyperloopJSValueRefToUIFontDescriptorSymbolicTraits(JSContextRef,JSValueRef,JSValueRef*,bool*);
