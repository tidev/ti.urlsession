    ...
    @try
    {
    	switch (argumentCount)
    	{
            ...
            NSRange * range$2 = HyperloopJSValueRefToNSRange_P(ctx,arguments[2],exception,&range$2$free);
    	        id result$ = [nsattributedstring attribute:attrName$0 atIndex:location$1 effectiveRange:range$2];
            ...
            NSRange * rangeLimit$3 = HyperloopJSValueRefToNSRange(ctx,arguments[3],exception,&rangeLimit$3$free);
    	        id result$c$ = [nsattributedstring attribute:attrName$0 atIndex:location$1 longestEffectiveRange:range$2 inRange:*rangeLimit$3];
