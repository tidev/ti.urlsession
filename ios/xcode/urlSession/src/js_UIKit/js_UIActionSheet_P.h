...
extern JSValueRef HyperloopUIActionSheetStyleToJSValueRef(JSContextRef,UIActionSheetStyle);
extern JSValueRef HyperloopUIActionSheetToJSValueRef(JSContextRef,UIActionSheet *);
extern JSValueRef HyperloopboolToJSValueRef(JSContextRef,bool);
extern JSValueRef Hyperloopid_UIActionSheetDelegate_ToJSValueRef(JSContextRef,id<UIActionSheetDelegate>);
...
extern UIActionSheetStyle HyperloopJSValueRefToUIActionSheetStyle(JSContextRef,JSValueRef,JSValueRef*,bool*);
...
extern UITabBar * HyperloopJSValueRefToUITabBar(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern UIToolbar * HyperloopJSValueRefToUIToolbar(JSContextRef,JSValueRef,JSValueRef*,bool*);
...
extern id<UIActionSheetDelegate> HyperloopJSValueRefToid_UIActionSheetDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
