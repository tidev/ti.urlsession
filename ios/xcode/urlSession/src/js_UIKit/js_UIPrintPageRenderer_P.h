...
extern JSValueRef HyperloopUIPrintPageRendererToJSValueRef(JSContextRef,UIPrintPageRenderer *);
...
extern UIPrintFormatter * HyperloopJSValueRefToUIPrintFormatter(JSContextRef,JSValueRef,JSValueRef*,bool*);
