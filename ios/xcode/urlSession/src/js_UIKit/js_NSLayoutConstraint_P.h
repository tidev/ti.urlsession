...
extern JSValueRef HyperloopNSLayoutAttributeToJSValueRef(JSContextRef,NSLayoutAttribute);
extern JSValueRef HyperloopNSLayoutConstraintToJSValueRef(JSContextRef,NSLayoutConstraint *);
extern JSValueRef HyperloopNSLayoutRelationToJSValueRef(JSContextRef,NSLayoutRelation);
...
extern NSLayoutAttribute HyperloopJSValueRefToNSLayoutAttribute(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSLayoutFormatOptions HyperloopJSValueRefToNSLayoutFormatOptions(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSLayoutRelation HyperloopJSValueRefToNSLayoutRelation(JSContextRef,JSValueRef,JSValueRef*,bool*);
