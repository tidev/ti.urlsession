...
extern JSValueRef Hyperloopid_UITabBarControllerDelegate_ToJSValueRef(JSContextRef,id<UITabBarControllerDelegate>);
...
extern id<UITabBarControllerDelegate> HyperloopJSValueRefToid_UITabBarControllerDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
