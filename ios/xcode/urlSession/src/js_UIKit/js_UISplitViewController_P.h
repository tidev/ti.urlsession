...
extern JSValueRef Hyperloopid_UISplitViewControllerDelegate_ToJSValueRef(JSContextRef,id<UISplitViewControllerDelegate>);
...
extern id<UISplitViewControllerDelegate> HyperloopJSValueRefToid_UISplitViewControllerDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
