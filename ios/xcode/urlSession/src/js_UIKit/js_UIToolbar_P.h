...
extern JSValueRef Hyperloopid_UIToolbarDelegate_ToJSValueRef(JSContextRef,id<UIToolbarDelegate>);
...
extern id<UIToolbarDelegate> HyperloopJSValueRefToid_UIToolbarDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
