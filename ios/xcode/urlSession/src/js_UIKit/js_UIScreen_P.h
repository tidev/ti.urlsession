...
extern JSValueRef HyperloopCADisplayLinkToJSValueRef(JSContextRef,CADisplayLink *);
...
extern JSValueRef HyperloopUIScreenModeToJSValueRef(JSContextRef,UIScreenMode *);
extern JSValueRef HyperloopUIScreenOverscanCompensationToJSValueRef(JSContextRef,UIScreenOverscanCompensation);
extern JSValueRef HyperloopUIScreenToJSValueRef(JSContextRef,UIScreen *);
...
extern UIScreenMode * HyperloopJSValueRefToUIScreenMode(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern UIScreenOverscanCompensation HyperloopJSValueRefToUIScreenOverscanCompensation(JSContextRef,JSValueRef,JSValueRef*,bool*);
