...
extern JSValueRef HyperloopUIEventSubtypeToJSValueRef(JSContextRef,UIEventSubtype);
extern JSValueRef HyperloopUIEventToJSValueRef(JSContextRef,UIEvent *);
extern JSValueRef HyperloopUIEventTypeToJSValueRef(JSContextRef,UIEventType);
