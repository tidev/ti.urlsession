...
extern CAMediaTimingFunction * HyperloopJSValueRefToCAMediaTimingFunction(JSContextRef,JSValueRef,JSValueRef*,bool*);
...
extern JSValueRef HyperloopCAMediaTimingFunctionToJSValueRef(JSContextRef,CAMediaTimingFunction *);
