...
extern JSValueRef HyperloopCGColorSpaceRefToJSValueRef(JSContextRef,CGColorSpaceRef *);
extern JSValueRef HyperloopCGFloat_PToJSValueRef(JSContextRef,CGFloat *,size_t);
extern JSValueRef HyperloopCIColorToJSValueRef(JSContextRef,CIColor *);
