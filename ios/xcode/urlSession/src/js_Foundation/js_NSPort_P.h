...
extern JSValueRef HyperloopNSPortToJSValueRef(JSContextRef,NSPort *);
...
extern JSValueRef Hyperloopid_NSPortDelegate_ToJSValueRef(JSContextRef,id<NSPortDelegate>);
...
extern NSMutableArray * HyperloopJSValueRefToNSMutableArray(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSPort * HyperloopJSValueRefToNSPort(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSRunLoop * HyperloopJSValueRefToNSRunLoop(JSContextRef,JSValueRef,JSValueRef*,bool*);
...
extern id<NSPortDelegate> HyperloopJSValueRefToid_NSPortDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
