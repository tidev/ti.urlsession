...
extern JSValueRef HyperloopNSURLSessionTaskStateToJSValueRef(JSContextRef,NSURLSessionTaskState);
extern JSValueRef HyperloopNSURLSessionTaskToJSValueRef(JSContextRef,NSURLSessionTask *);
