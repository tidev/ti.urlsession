...
extern JSValueRef HyperloopNSMutableDictionaryToJSValueRef(JSContextRef,NSMutableDictionary *);
...
extern JSValueRef HyperloopNSThreadToJSValueRef(JSContextRef,NSThread *);
