...
extern JSValueRef HyperloopNSKeyedArchiverToJSValueRef(JSContextRef,NSKeyedArchiver *);
extern JSValueRef HyperloopNSMethodSignatureToJSValueRef(JSContextRef,NSMethodSignature *);
extern JSValueRef HyperloopNSPropertyListFormatToJSValueRef(JSContextRef,NSPropertyListFormat);
...
extern JSValueRef Hyperloopid_NSKeyedArchiverDelegate_ToJSValueRef(JSContextRef,id<NSKeyedArchiverDelegate>);
extern JSValueRef Hyperloopid__P__id__SEL______ToJSValueRef(JSContextRef,Function_id__P__id__SEL______);
extern NSMutableData * HyperloopJSValueRefToNSMutableData(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSPropertyListFormat HyperloopJSValueRefToNSPropertyListFormat(JSContextRef,JSValueRef,JSValueRef*,bool*);
...
extern id<NSKeyedArchiverDelegate> HyperloopJSValueRefToid_NSKeyedArchiverDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
