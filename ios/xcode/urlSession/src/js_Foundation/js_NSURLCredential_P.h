...
extern JSValueRef HyperloopNSURLCredentialPersistenceToJSValueRef(JSContextRef,NSURLCredentialPersistence);
extern JSValueRef HyperloopNSURLCredentialToJSValueRef(JSContextRef,NSURLCredential *);
extern JSValueRef HyperloopSecIdentityRefToJSValueRef(JSContextRef,SecIdentityRef *);
...
extern NSURLCredentialPersistence HyperloopJSValueRefToNSURLCredentialPersistence(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern SEL HyperloopJSValueRefToSEL(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern SecIdentityRef * HyperloopJSValueRefToSecIdentityRef(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern SecTrustRef * HyperloopJSValueRefToSecTrustRef(JSContextRef,JSValueRef,JSValueRef*,bool*);
