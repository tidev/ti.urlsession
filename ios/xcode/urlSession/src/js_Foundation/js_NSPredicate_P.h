...
extern Block_BOOL__B__id__NSDictionary_P_ HyperloopJSValueRefToBOOL__B__id__NSDictionary_P_(JSContextRef,JSObjectRef,JSValueRef,JSValueRef*,bool*);
...
extern JSValueRef HyperloopNSPredicateToJSValueRef(JSContextRef,NSPredicate *);
