...
extern JSValueRef HyperloopNSCachedURLResponseToJSValueRef(JSContextRef,NSCachedURLResponse *);
...
extern NSCachedURLResponse * HyperloopJSValueRefToNSCachedURLResponse(JSContextRef,JSValueRef,JSValueRef*,bool*);
