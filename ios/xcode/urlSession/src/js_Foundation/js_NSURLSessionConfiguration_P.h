...
extern JSValueRef HyperloopNSHTTPCookieAcceptPolicyToJSValueRef(JSContextRef,NSHTTPCookieAcceptPolicy);
extern JSValueRef HyperloopNSHTTPCookieStorageToJSValueRef(JSContextRef,NSHTTPCookieStorage *);
...
extern JSValueRef HyperloopNSURLCacheToJSValueRef(JSContextRef,NSURLCache *);
extern JSValueRef HyperloopNSURLCredentialStorageToJSValueRef(JSContextRef,NSURLCredentialStorage *);
extern JSValueRef HyperloopNSURLSessionConfigurationToJSValueRef(JSContextRef,NSURLSessionConfiguration *);
extern JSValueRef HyperloopSSLProtocolToJSValueRef(JSContextRef,SSLProtocol);
...
extern NSHTTPCookieAcceptPolicy HyperloopJSValueRefToNSHTTPCookieAcceptPolicy(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSHTTPCookieStorage * HyperloopJSValueRefToNSHTTPCookieStorage(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSString * HyperloopJSValueRefToNSString(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSURLCache * HyperloopJSValueRefToNSURLCache(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern NSURLCredentialStorage * HyperloopJSValueRefToNSURLCredentialStorage(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern SEL HyperloopJSValueRefToSEL(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern SSLProtocol HyperloopJSValueRefToSSLProtocol(JSContextRef,JSValueRef,JSValueRef*,bool*);
