...
extern JSValueRef HyperloopNSStreamStatusToJSValueRef(JSContextRef,NSStreamStatus);
extern JSValueRef HyperloopNSStreamToJSValueRef(JSContextRef,NSStream *);
...
extern JSValueRef Hyperloopid_NSStreamDelegate_ToJSValueRef(JSContextRef,id<NSStreamDelegate>);
...
extern id<NSStreamDelegate> HyperloopJSValueRefToid_NSStreamDelegate_(JSContextRef,JSValueRef,JSValueRef*,bool*);
