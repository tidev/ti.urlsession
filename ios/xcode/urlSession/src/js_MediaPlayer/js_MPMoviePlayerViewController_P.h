...
/**
 * JSC implementation for MediaPlayer/undefined
 */
...
extern JSValueRef HyperloopMPMoviePlayerViewControllerToJSValueRef(JSContextRef,MPMoviePlayerViewController *);
