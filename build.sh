...
# This script will compile and package the urlSession iOS
...
echo_and_eval "\"${TI_ROOT}/titanium_mobile/apidoc/docgen.py\" -f modulehtml -o ${module_package_path}/apidoc -e apidoc --css styles.css"
echo_and_eval "\"${TI_ROOT}/titanium_mobile/apidoc/docgen.py\" -f jsca       -o ${module_package_path}/apidoc -e apidoc"
